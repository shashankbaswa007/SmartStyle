    ...
    return (
      <Comp
        ...
        className={cn(
          ...
          'bg-black/30 px-6 py-2.5 text-[15px] font-semibold tracking-wide text-teal-200',
          ...
          'focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-teal-300/50 focus-visible:ring-offset-2 focus-visible:ring-offset-black/50',
