...
const STAT_ACCENT: Record<string, string> = {
  teal: '#10B981', emerald: '#14B8A6', cyan: '#06B6D4', green: '#34D399',
};
          ...
          {loading ? (
            ...
            <motion.div variants={containerVariants} initial="hidden" animate="visible" className="space-y-6 max-w-7xl mx-auto">
              ...
              <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                <StatCard title="Recommendations" value={insights.totalRecommendations} subtitle="Outfits generated for you" icon={Sparkles} color="emerald" />
                <StatCard title="Liked Outfits" value={insights.totalLiked} subtitle={`${insights.likeRate.toFixed(0)}% like rate`} icon={Heart} color="teal" />
                <StatCard title="Wardrobe Items" value={insights.wardrobeTotal} subtitle={`${insights.wardrobeBreakdown.length} categories`} icon={Shirt} color="emerald" />
